...
class MeshConvNetReg(nn.Module):
    """Network for learning a global shape descriptor (classification)
    """
    def __init__(self, norm_layer, nf0, conv_res, nclasses, input_res, pool_res, fc_n,
                 nresblocks=3):
        super(MeshConvNetReg, self).__init__()
        self.k = [nf0] + conv_res
        self.res = [input_res] + pool_res
        norm_args = networks.get_norm_args(norm_layer, self.k[1:])
...
class RegressionModel:
    ...
    def __init__(self, opt):
        ...
        net = MeshConvNetReg(norm_layer, opt.input_nc, opt.ncf, opt.nclasses, opt.ninput_edges, opt.pool_res, opt.fc_n,
                              opt.resblocks)
