...
ms.meshing_surface_subdivision_midpoint(threshold = pymeshlab.PercentageValue(3.000003))
...
ms.compute_selection_by_color_per_face(color = pymeshlab.Color(255, 0, 0, 255), percentrh = 0.1, percentgs = 0.090000, percentbv = 0.110000)
...
ms.compute_selection_by_color_per_face(color = pymeshlab.Color(0, 255, 8, 255))
ms.meshing_isotropic_explicit_remeshing(iterations = 3,
                                        selectedonly = True,
